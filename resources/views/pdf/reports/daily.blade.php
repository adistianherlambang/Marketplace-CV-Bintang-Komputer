...
<body>
    ...
    <h3 style="text-align: center; margin-top: 0; text-transform: uppercase;">LAPORAN PENJUALAN HARIAN</h3>
    <div class="subtitle">Tanggal Laporan: {{ $data['date'] }}</div>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th style="width: 20%;">Kasir (Admin)</th>
